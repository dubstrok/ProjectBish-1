...
@register(outgoing=True, pattern="^.savefilter (.*)")
...
@register(outgoing=True, pattern="^.listfilters$")
...
@register(outgoing=True, pattern="^.clearfilter (.*)")
...
CMD_HELP.update({
    ...
    "\n\n>`.savefilter <keyword> <reply text>` or reply to a message with "
    ">`.savefilter <keyword>`"
    ...
    "\n\n>`.clearallfilters <marie/rose>`"
    "\nUsage: Removes all filters in the chat."
})
