...
from userbot import CMD_HELP, LOGS, ALIVE_NAME
...
SLAP_TEMPLATES = [
    ...
    " {hits} {victim} di mukanya dengan {item}.",
    " {hits} {victim} dengan keras menggunakan {item}.",
    " {throws} sebuah {item} ke {victim}.",
    "  mengubah status {victim} menjadi Deleted Account.",
    " melempar sebuah {item} ke {victim}.",
    " mulai menampar konyol {victim} dengan {item}.",
    " menusuk {victim} dan berulang kali {hits} dia dengan {item}.",
    " {hits} {victim} dengan sebuah {item}.",
    " mengikat {victim} ke kursi dan {throws} sebuah {item}.",
    " menghapus {victim} dari database seluruh internet!",
    " menaruh {victim} {where}."
]
